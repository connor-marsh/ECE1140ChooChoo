...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Advertisements.setPixmap(QPixmap(r"Train\assets\pizza_hut_ad_1.jpg"))
        ...
        self.Advertisements_2.setPixmap(QPixmap(r"Train\assets\McD.jpg"))
        ...
        self.Advertisements_3.setPixmap(QPixmap(r"Train\assets\whopper.jpg"))
