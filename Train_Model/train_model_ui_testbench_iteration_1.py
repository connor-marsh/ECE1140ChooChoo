...
class Ui_TestMainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        # Inputs translations
        self.WaysideSpeedLabel.setText(QCoreApplication.translate("MainWindow", "Wayside Speed (m/s)", None))
        self.WaysideAuthorityLabel.setText(QCoreApplication.translate("MainWindow", "Wayside Authority (m)", None))
        self.CommandedPowerLabel.setText(QCoreApplication.translate("MainWindow", "Commanded Power (W)", None))
        self.SpeedLimitLabel.setText(QCoreApplication.translate("MainWindow", "Speed Limit (m/s)", None))
        ...
        self.LengthVehicleLabel.setText(QCoreApplication.translate("MainWindow", "Length of Vehicle (m)", None))
        self.HeightVehicleLabel.setText(QCoreApplication.translate("MainWindow", "Height of Vehicle (m)", None))
        self.WidthVehicleLabel.setText(QCoreApplication.translate("MainWindow", "Width of Vehicle (m)", None))
        self.GradePercentLabel.setText(QCoreApplication.translate("MainWindow", "Grade (%)", None))
        self.MassVehicleLabel.setText(QCoreApplication.translate("MainWindow", "Mass of Vehicle (t)", None))
