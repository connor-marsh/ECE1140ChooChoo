...
class Controller(QObject):
    ...
    def from_ui(self, data):
        ...
        valid_speed = self.validate_data(data["Commanded Speed"])
        self.block_table_data["Commanded Speed"] = valid_speed
        self.block_table_data["Commanded Speed"] = data["Commanded Speed"]
        self.block_table_data["Commanded Authority"] = data["Commanded Authority"]
